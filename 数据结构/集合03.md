...
- 案例需求
  ...
  - 用 TreeSet 集合存储多个学生信息(姓名,语文成绩,数学成绩,英语成绩),并遍历该集合
  - 要求: 按照总分从高到低出现
...
![HashSet1.8存储流程](F:\_2020-JavaEE-Study\_My Note\数据结构\img\HashSet1.8存储流程.png)
